 ...
 */
#define CMD_GET_PUBLIC_KEY 0x00000001
...
/*!
 * \brief exportPublicKey
 * Extract the public key from the trusted execution environment
 * \param key [IN/OUT] A non-NULL buffer to return the public part of the device specific key
